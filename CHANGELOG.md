...
- **tesserix_adk.adapters, tesserix_adk.adapters.isolation, tesserix_adk.core.errors**: Tenant scoping in a store adapter is now derived rather than passed. `Partition.current()`
...
- Added: `tesserix_adk.adapters.ADAPTER_GUARANTEES`
- Added: `tesserix_adk.adapters.ErasureSweep`
- Added: `tesserix_adk.adapters.IsolationGuarantee`
- Added: `tesserix_adk.adapters.Isolator`
- Added: `tesserix_adk.adapters.Partition`
- Added: `tesserix_adk.adapters.PartitionMechanism`
- Added: `tesserix_adk.adapters.isolation.ADAPTER_GUARANTEES`
- Added: `tesserix_adk.adapters.isolation.ErasureSweep`
- Added: `tesserix_adk.adapters.isolation.IsolationGuarantee`
- Added: `tesserix_adk.adapters.isolation.Isolator`
- Added: `tesserix_adk.adapters.isolation.Partition`
- Added: `tesserix_adk.adapters.isolation.PartitionMechanism`
- Added: `tesserix_adk.adapters.isolation.partitioned`
- Added: `tesserix_adk.adapters.partitioned`
- Added: `tesserix_adk.core.TenantIsolationError`
- Added: `tesserix_adk.core.errors.TenantIsolationError`

## 0.37.0

### Added

- **tesserix_adk.runtime, tesserix_adk.runtime.credentials, tesserix_adk.core.credentials**: A run that outlives its token no longer has to choose between a longer TTL and
...
- Added: `tesserix_adk.core.AuthorityRevokedError`
- Added: `tesserix_adk.core.CredentialExpiredError`
- Added: `tesserix_adk.core.ExpiringCredential`
- Added: `tesserix_adk.core.ExpiringCredentialSource`
- Added: `tesserix_adk.core.credentials.ExpiringCredential`
- Added: `tesserix_adk.core.credentials.ExpiringCredentialSource`
- Added: `tesserix_adk.core.errors.AuthorityRevokedError`
- Added: `tesserix_adk.core.errors.CredentialExpiredError`
- Added: `tesserix_adk.runtime.DEFAULT_SKEW_SECONDS`
- Added: `tesserix_adk.runtime.Reauthoriser`
- Added: `tesserix_adk.runtime.RefreshPolicy`
- Added: `tesserix_adk.runtime.RunCredentials`
- Added: `tesserix_adk.runtime.credentials.DEFAULT_SKEW_SECONDS`
- Added: `tesserix_adk.runtime.credentials.Reauthoriser`
- Added: `tesserix_adk.runtime.credentials.RefreshPolicy`
- Added: `tesserix_adk.runtime.credentials.RunCredentials`
...
- **tesserix_adk.mcp, tesserix_adk.mcp.auth, tesserix_adk.core.errors**: Credential and scope propagation to MCP servers.
...
- Added: `tesserix_adk.core.McpAuthError`
- Added: `tesserix_adk.core.McpAuthReason`
- Added: `tesserix_adk.core.errors.McpAuthError`
- Added: `tesserix_adk.core.errors.McpAuthReason`
- Added: `tesserix_adk.mcp.AuthorisedCall`
- Added: `tesserix_adk.mcp.CallCredential`
- Added: `tesserix_adk.mcp.CredentialSource`
- Added: `tesserix_adk.mcp.META_PREFIX`
- Added: `tesserix_adk.mcp.McpAuthorizer`
- Added: `tesserix_adk.mcp.McpServerAuth`
- Added: `tesserix_adk.mcp.ServerSessions`
- Added: `tesserix_adk.mcp.SessionLease`
- Added: `tesserix_adk.mcp.auth.AuthorisedCall`
- Added: `tesserix_adk.mcp.auth.CallCredential`
- Added: `tesserix_adk.mcp.auth.CredentialSource`
- Added: `tesserix_adk.mcp.auth.META_PREFIX`
- Added: `tesserix_adk.mcp.auth.McpAuthorizer`
- Added: `tesserix_adk.mcp.auth.McpServerAuth`
- Added: `tesserix_adk.mcp.auth.ServerSessions`
- Added: `tesserix_adk.mcp.auth.SessionLease`
...
- **tesserix_adk.core.identity, tesserix_adk.core.agent, tesserix_adk.core.errors**: An agent can now say that it acts for its caller, and the runtime holds it to that.
...
- Added: `tesserix_adk.core.AgentIdentity`
- Added: `tesserix_adk.core.AuthMethod`
- Added: `tesserix_adk.core.AuthorisationError`
- Added: `tesserix_adk.core.Principal`
- Added: `tesserix_adk.core.ScopeSet`
- Added: `tesserix_adk.core.current_principal`
- Added: `tesserix_adk.core.errors.AuthorisationError`
- Added: `tesserix_adk.core.identity.AgentIdentity`
- Added: `tesserix_adk.core.identity.AuthMethod`
- Added: `tesserix_adk.core.identity.Principal`
- Added: `tesserix_adk.core.identity.ScopeSet`
- Added: `tesserix_adk.core.identity.current_principal`
- Added: `tesserix_adk.core.identity.principal_here`
- Added: `tesserix_adk.core.identity.principal_scope`
- Added: `tesserix_adk.core.principal_here`
- Added: `tesserix_adk.core.principal_scope`
...
- **tesserix_adk.core.tool_access, tesserix_adk.guardrails.allowlist**: The tools a run may call are now resolved once, from every layer that has a say, into a
...
- Added: `tesserix_adk.core.DenyReason`
- Added: `tesserix_adk.core.ToolAllowlist`
- Added: `tesserix_adk.core.ToolDecision`
- Added: `tesserix_adk.core.canonical`
- Added: `tesserix_adk.core.tool_access.DenyReason`
- Added: `tesserix_adk.core.tool_access.ToolAllowlist`
- Added: `tesserix_adk.core.tool_access.ToolDecision`
- Added: `tesserix_adk.core.tool_access.canonical`
- Added: `tesserix_adk.guardrails.ToolAllowlistGuard`
- Added: `tesserix_adk.guardrails.allowlist.ToolAllowlistGuard`
...
- **tesserix_adk.core.provenance, tesserix_adk.core.injection, tesserix_adk.guardrails.injection**: Content the caller did not write is now data everywhere it goes, rather than a paragraph of
...
- Added: `tesserix_adk.core.ContentSource`
- Added: `tesserix_adk.core.InjectionSignal`
- Added: `tesserix_adk.core.InjectionSuspectedError`
- Added: `tesserix_adk.core.Origin`
- Added: `tesserix_adk.core.SignalKind`
- Added: `tesserix_adk.core.TRUST_BY_ORIGIN`
- Added: `tesserix_adk.core.TrustLevel`
- Added: `tesserix_adk.core.injection.InjectionSignal`
- Added: `tesserix_adk.core.injection.SignalKind`
- Added: `tesserix_adk.core.injection.screen`
- Added: `tesserix_adk.core.provenance.ContentSource`
- Added: `tesserix_adk.core.provenance.Origin`
- Added: `tesserix_adk.core.provenance.TRUST_BY_ORIGIN`
- Added: `tesserix_adk.core.provenance.TrustLevel`
- Added: `tesserix_adk.core.provenance.sealed`
- Added: `tesserix_adk.core.provenance.weakest`
- Added: `tesserix_adk.core.screen`
- Added: `tesserix_adk.core.sealed`
- Added: `tesserix_adk.core.weakest`
- Added: `tesserix_adk.guardrails.Containment`
- Added: `tesserix_adk.guardrails.InjectionGuard`
- Added: `tesserix_adk.guardrails.injection.Containment`
- Added: `tesserix_adk.guardrails.injection.InjectionGuard`

## 0.26.0

### Added

- **tesserix_adk.core.activities, tesserix_adk.runtime.activities, tesserix_adk.workflows.policies**: Retry and timeout numbers are now declared per activity class rather than picked once for
...
- Added: `tesserix_adk.core.ActivityClass`
- Added: `tesserix_adk.core.ActivityPolicy`
- Added: `tesserix_adk.core.Backoff`
- Added: `tesserix_adk.core.DEFAULT_ACTIVITY_POLICIES`
- Added: `tesserix_adk.core.Heartbeat`
- Added: `tesserix_adk.core.NEVER_RETRYABLE`
- Added: `tesserix_adk.core.activities.ActivityClass`
- Added: `tesserix_adk.core.activities.ActivityPolicy`
- Added: `tesserix_adk.core.activities.Backoff`
- Added: `tesserix_adk.core.activities.DEFAULT_ACTIVITY_POLICIES`
- Added: `tesserix_adk.core.activities.Heartbeat`
- Added: `tesserix_adk.core.activities.NEVER_RETRYABLE`
- Added: `tesserix_adk.runtime.ActivityAttempts`
- Added: `tesserix_adk.runtime.AttemptBudget`
- Added: `tesserix_adk.runtime.Heartbeater`
- Added: `tesserix_adk.runtime.activities.ActivityAttempts`
- Added: `tesserix_adk.runtime.activities.AttemptBudget`
- Added: `tesserix_adk.runtime.activities.Heartbeater`
- Added: `tesserix_adk.workflows.activity_policy_for`
- Added: `tesserix_adk.workflows.attempts_for_tool`
- Added: `tesserix_adk.workflows.policies.activity_policy_for`
- Added: `tesserix_adk.workflows.policies.attempts_for_tool`
- Added: `tesserix_adk.workflows.policies.policy_for_tool`
- Added: `tesserix_adk.workflows.policy_for_tool`
...
- **tesserix_adk.workflows.durable**: An agent run can now be a resumable unit of work. `AgentWorkflow` drives the same loop as the
...
- Added: `tesserix_adk.core.PayloadTooLargeError`
- Added: `tesserix_adk.core.errors.PayloadTooLargeError`
- Added: `tesserix_adk.workflows.Activities`
- Added: `tesserix_adk.workflows.ActivityContext`
- Added: `tesserix_adk.workflows.AgentWorkflow`
- Added: `tesserix_adk.workflows.Cancellation`
- Added: `tesserix_adk.workflows.Journal`
- Added: `tesserix_adk.workflows.ModelCallInput`
- Added: `tesserix_adk.workflows.ModelCallResult`
- Added: `tesserix_adk.workflows.PAYLOAD_LIMIT_BYTES`
- Added: `tesserix_adk.workflows.STREAMING_UNSUPPORTED`
- Added: `tesserix_adk.workflows.ToolCallInput`
- Added: `tesserix_adk.workflows.ToolCallResult`
- Added: `tesserix_adk.workflows.WorkflowState`
- Added: `tesserix_adk.workflows.durable.Activities`
- Added: `tesserix_adk.workflows.durable.ActivityContext`
- Added: `tesserix_adk.workflows.durable.AgentWorkflow`
- Added: `tesserix_adk.workflows.durable.Cancellation`
- Added: `tesserix_adk.workflows.durable.Journal`
- Added: `tesserix_adk.workflows.durable.ModelCallInput`
- Added: `tesserix_adk.workflows.durable.ModelCallResult`
- Added: `tesserix_adk.workflows.durable.PAYLOAD_LIMIT_BYTES`
- Added: `tesserix_adk.workflows.durable.STREAMING_UNSUPPORTED`
- Added: `tesserix_adk.workflows.durable.ToolCallInput`
- Added: `tesserix_adk.workflows.durable.ToolCallResult`
- Added: `tesserix_adk.workflows.durable.WorkflowState`

## 0.21.0

### Added

- **tesserix_adk.evals.gate**: A prompt change is now comparable against the version in production before it ships. `gate`
...
- Added: `tesserix_adk.core.EvalIncompleteError`
- Added: `tesserix_adk.core.IncomparableEvalError`
- Added: `tesserix_adk.core.errors.EvalIncompleteError`
- Added: `tesserix_adk.core.errors.IncomparableEvalError`
- Added: `tesserix_adk.evals.Bypass`
- Added: `tesserix_adk.evals.DEFAULT_POLICY`
- Added: `tesserix_adk.evals.GatePolicy`
- Added: `tesserix_adk.evals.GateReport`
- Added: `tesserix_adk.evals.Measured`
- Added: `tesserix_adk.evals.MetricMove`
- Added: `tesserix_adk.evals.Tolerance`
- Added: `tesserix_adk.evals.Verdict`
- Added: `tesserix_adk.evals.gate`
- Added: `tesserix_adk.evals.gate.Bypass`
- Added: `tesserix_adk.evals.gate.DEFAULT_POLICY`
- Added: `tesserix_adk.evals.gate.GatePolicy`
- Added: `tesserix_adk.evals.gate.GateReport`
- Added: `tesserix_adk.evals.gate.Measured`
- Added: `tesserix_adk.evals.gate.MetricMove`
- Added: `tesserix_adk.evals.gate.Tolerance`
- Added: `tesserix_adk.evals.gate.Verdict`
- Added: `tesserix_adk.evals.gate.gate`
