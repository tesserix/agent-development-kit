<!-- generated from SECURITY.md by tools.policy_pages; do not edit -->
# Security policy
...
[`docs/versioning.md`](versioning.md). Before 1.0 that means the current minor and
...
[`docs/threat-model.md`](threat-model.md). Read it before treating any of the kit's
...
- [`docs/security.md`](security.md) — advisory, secret and licence scanning gates.
- [`docs/verifying.md`](verifying.md) — verifying a release's signature and provenance.
- [`docs/dependencies.md`](dependencies.md) — dependency policy and the advisory fast lane.
